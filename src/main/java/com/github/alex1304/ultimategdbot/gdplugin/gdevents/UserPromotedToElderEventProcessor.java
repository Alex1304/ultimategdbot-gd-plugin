...
public class UserPromotedToElderEventProcessor extends UserEventSubscriber<UserPromotedToElderEvent> {
	...
	public UserPromotedToElderEventProcessor(Bot bot, ChannelLoader channelLoader, Map<Long, List<Message>> broadcastedMessages,
			SpriteFactory spriteFactory, Map<GDUserIconSet, String[]> iconsCache, AuthenticatedGDClient gdClient) {
		super(UserPromotedToElderEvent.class, bot, channelLoader, broadcastedMessages, spriteFactory, iconsCache, gdClient);
	}
