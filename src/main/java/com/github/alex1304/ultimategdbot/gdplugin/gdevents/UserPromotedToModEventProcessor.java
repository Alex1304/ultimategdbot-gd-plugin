...
public class UserPromotedToModEventProcessor extends UserEventSubscriber<UserPromotedToModEvent> {
	...
	public UserPromotedToModEventProcessor(Bot bot, BroadcastPreloader preloader, Map<Long, List<Message>> broadcastedMessages,
			SpriteFactory spriteFactory, Map<GDUserIconSet, String[]> iconsCache, AuthenticatedGDClient gdClient) {
		super(UserPromotedToModEvent.class, bot, preloader, broadcastedMessages, spriteFactory, iconsCache, gdClient);
	}
